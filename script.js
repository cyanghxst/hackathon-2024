...
let targets = [
    { x: 612, y: 90, radius: 100, z: 1, color: "red", speed: 2, direction: 1, hit: false, animationDone: false, currentFrame: 0 },
    { x: 612, y: 220, radius: 100, z: 1, color: "blue", speed: 3, direction: 1, hit: false, animationDone: false, currentFrame: 0 },
    { x: 612, y: 375, radius: 100, z: 1, color: "green", speed: 4, direction: 1, hit: false, animationDone: false, currentFrame: 0 },
];
...
function HitorMiss() {
    ...
    ctx.fillStyle = "white";
    ctx.fillText(`Hit: ${clickHit}`, 20, 650);
    ctx.fillText(`Clicks: ${clickCounter}`, 20, 700);
